...
public class DecentPosition {
	...
	private final com.oolongho.holograms.nms.util.HologramPosition handle;

	public DecentPosition(double x, double y, double z) {
		this.handle = new com.oolongho.holograms.nms.util.HologramPosition(x, y, z);
	}

	public DecentPosition(double x, double y, double z, float yaw, float pitch) {
		this.handle = new com.oolongho.holograms.nms.util.HologramPosition(x, y, z, yaw, pitch);
	}

	private DecentPosition(com.oolongho.holograms.nms.util.HologramPosition handle) {
		this.handle = handle;
	}
	...
	public static DecentPosition fromBukkitLocation(Location location) {
		return new DecentPosition(com.oolongho.holograms.nms.util.HologramPosition.fromBukkitLocation(location));
	}
	...
	public com.oolongho.holograms.nms.util.HologramPosition getHandle() {
		return handle;
	}
}
