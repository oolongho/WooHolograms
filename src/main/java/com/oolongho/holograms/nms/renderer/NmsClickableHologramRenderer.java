...
public interface NmsClickableHologramRenderer extends NmsHologramRenderer {
     ...
     */
    @Override
    default void render(Player player, Location location, com.oolongho.holograms.hologram.HologramLine line) {
        // 可点击渲染器不需要渲染内容
    }
     ...
     */
    @Override
    default void render(java.util.Collection<Player> players, Location location, com.oolongho.holograms.hologram.HologramLine line) {
        // 可点击渲染器不需要渲染内容
    }
     ...
     */
    @Override
    default void updateText(Player player, com.oolongho.holograms.hologram.HologramLine line) {
        // 可点击渲染器不需要更新文本
    }
     ...
     */
    @Override
    default void updateText(java.util.Collection<Player> players, com.oolongho.holograms.hologram.HologramLine line) {
        // 可点击渲染器不需要更新文本
    }
