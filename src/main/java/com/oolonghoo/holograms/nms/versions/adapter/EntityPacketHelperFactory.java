package com.oolonghoo.holograms.nms.versions.adapter;

import com.oolonghoo.holograms.nms.versions.adapter.v1_21_0.LegacyEntityPacketHelper;
import com.oolonghoo.holograms.nms.versions.adapter.v1_21_2.ModernEntityPacketHelper;
import org.bukkit.Bukkit;

public final class EntityPacketHelperFactory {

    private static final EntityPacketHelper INSTANCE = create();

    public static EntityPacketHelper getInstance() {
        return INSTANCE;
    }
