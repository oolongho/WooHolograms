...
- **DH API compat**: Auto-takes over plugins depending on DH API
...
Visit the [Wiki](https://github.com/oolongho/WooHolograms/wiki) for complete documentation

---

❤️ The author is a beginner developer. Feedback and suggestions are welcome!
